...
export default function BlogHeader() {
  return (
    <div className="flex items-center justify-between flex-wrap mb-10">
        {/* user avatar */}
        <div>
            <img className="rouned-full sm:w-[100px]" src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" alt="this is user's avatar" />
        </div>
        {/* usre info */}
        ...
        {/* links */}
        <div className='flex items-center flex-wrap justify-between w-[30%] md:w-[25%]'>
