  ...
  return (
    <div>
      <div className='bg-[#ffc017] '>
        ...
        <div className='container mx-auto py-14'>
          {/* hero section */}
          <h1 className='font-["labrada"] text-8xl'>Stay curious.</h1>
          <p className="w-[30%] my-8 leading-6">Discover stories, thinking, and expertise from writers on any topic.</p>
    ...
    {/* suggestions and sidebar */}
      <div className='container mx-auto mt-10 flex gap-10'>
        ...
        {/* sidebar */}
        <div className='flex flex-col h-[500px] w-[500px] sticky top-0'>
